...
steamcmd_dir="$HOME/Applications/steamcmd"
install_dir="$HOME/Library/Application Support/Steam/steamapps/common/Don't Starve Together Dedicated Server"
cluster_name="HoneyBee"
